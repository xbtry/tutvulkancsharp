...
unsafe class VulkanTutorialApp
{
    ...
    private void CreateVertexBuffer()
    {
        ...
        {
            if (_vk!.CreateBuffer(_device, in bufferCreateInfo, null, vertexBufferPtr) != Result.Success)
            {
        ...
        _vk!.GetBufferMemoryRequirements(_device, _vertexBuffer, out memoryRequirements);
        ...
        {
            if (_vk!.AllocateMemory(_device, in memoryAllocateInfo, null, vertexBufferMemoryPtr) != Result.Success)
            {
        ...
        void* data;
        _vk!.MapMemory(_device, _vertexBufferMemory, 0, bufferCreateInfo.Size, 0, &data);
    ...
    private void CreateCommandBuffers()
    {
        ...
        for (int i = 0; i < _graphicsCommandBuffers.Length; i++)
        {
            ...
            _vk!.CmdDraw(_graphicsCommandBuffers[i], (uint)vertices.Length, 1, 0 , 0);
